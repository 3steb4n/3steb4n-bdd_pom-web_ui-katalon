...
public class LoginPage {
	private static final TestObject INPUT_USERNAME = findTestObject('Login_Page/inputUsername');
	private static final TestObject INPUT_PASSWORD = findTestObject('Login_Page/inputPassword');
	private static final TestObject BUTTON_LOGIN = findTestObject('Login_Page/buttonLogin');
